...
<div class="flex flex-col h-full">
  ...
  <div class="flex items-center justify-between px-5 pt-5 pb-4">
    ...
    <button onclick={onClose} class="text-text-tertiary hover-text-primary transition-[color] duration-150 p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="Close">
